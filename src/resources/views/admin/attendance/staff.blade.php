...
<div class="attendance-list__wrapper">
    <div class="attendance-list__content">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if ($latestRequest && $latestRequest->status === 'pending')
                                <a href="{{ route('stamp_correction_request.approve_form', $latestRequest->id) }}" class="attendance-list__detail-link">
                                    詳細
                                </a>
                            @else
                                <a href="{{ route('admin.attendance.show', $attendance->id) }}" class="attendance-list__detail-link">
                                    詳細
                                </a>
                            @endif
                        </td>
        ...
        <div class="attendance-list__csv-wrapper">
            <a href="{{ route('admin.attendance.staff.csv', ['id' => $user->id, 'month' => $currentMonth->format('Y-m')]) }}" class="attendance-list__csv-button">
                CSV出力
            </a>
        </div>
    </div>
